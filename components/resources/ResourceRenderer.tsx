      ...
      <div className={`space-y-3 ${className}`}>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-slate-500">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 font-semibold text-slate-500 hover:text-primary"
          >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-2 text-xs">
                ...
                {formattedSize && <span className="text-slate-500">{formattedSize}</span>}
              </div>
            </div>
          </div>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-xs font-bold text-white hover:bg-secondary transition shrink-0"
          >
